  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="gf-ambient">
        <span className="gf-glow-blue" style={{ top: "-180px", right: "-120px" }} />
        <span className="gf-glow-purple" style={{ bottom: "-200px", left: "-140px" }} />
      </div>
      <NavShell user={user} unread={unread} notificationHref={notificationHref} />
